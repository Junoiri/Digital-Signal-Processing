function [TS,Resp,BP,ECG]=get_AD_file()
% [Time,Resp,BP,ECG]=get_AD_file
% Time - vector of time samples
% Resp - Respiration signal
% BP - Blood pulse signal (from pulse-oximeter)
% ECG - electrocardiogram

% Updated 21 July 2010, DRI
[Name,Path]=uigetfile('*.txt','Select AD Instr. File');   
if Name==0 
    % do nothing
    return
else                   
